...
export default function SingleHomework(props: SingleHomeworkProps) {
    ...
    <div className="grid items-start sm:grid-cols-2">
      ...
      <div className="text-sm text-gray-500 dark:text-gray-400">开始时间: {props.start_date}</div>
    </div>
    <div className="text-sm text-gray-500 dark:text-gray-400">结束时间: {props.end_date}</div>
    </div>
    )
}